...
export class CoolerComponent implements OnInit, OnDestroy {
  parts: any[] = [];
  ...
  loadAllParts(): void {
    this.partService.getParts('cooler').subscribe(data => {
      this.parts = data;
  ...
  private performSearch(term: string): void {
    ...
    this.partService.searchParts('cooler', trimmed).subscribe(data => {
      this.parts = data;
      this.groupParts(this.parts);
    });
  }
