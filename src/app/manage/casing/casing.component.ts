...
export class CasingComponent implements OnInit, OnDestroy {
  parts: any[] = [];
  ...
  loadAllParts(): void {
    this.partService.getParts('casing').subscribe(data => {
      this.parts = data;
  ...
  private performSearch(term: string): void {
    ...
    this.partService.searchParts('casing', trimmed).subscribe(data => {
      this.parts = data;
      this.groupParts(this.parts);
    });
  }
